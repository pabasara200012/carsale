    ...
    const fetchVehicle = async () => {
      try {
        ...
        setFormData({
          ...
          shippingDate: vehicleData.shippingDate ? new Date(vehicleData.shippingDate).toISOString().split('T')[0] : '',
          arrivalDate: vehicleData.arrivalDate ? new Date(vehicleData.arrivalDate).toISOString().split('T')[0] : '',
